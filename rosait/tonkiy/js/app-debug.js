...
(function (factory) {
  ...
  function stickyHeader(e) {
    ...
    if (scrolled > 840 && scrolled > scrollPrev) {
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.team-slider__slider')) {
      var arrowPrev = document.querySelector('.team-slider .--prev');
      var arrowNext = document.querySelector('.team-slider .--next');
    ...
    if (document.querySelector('.partners-slider__slider')) {
      var _arrowPrev = document.querySelector('.partners-slider .--prev');

      var _arrowNext = document.querySelector('.partners-slider .--next');

      var pagination = document.querySelector('.partners-slider__pagination');
