...
(function (factory) {
  ...
  */
  ...
  window.onload = function () {
    ...
    var firstDropdown = document.querySelectorAll('.menu__list > .menu__dropdown');
    firstDropdown.forEach(function (item) {
      item.addEventListener('mouseenter', setDropdownHeight);
    });

    function setDropdownHeight(event) {
      var lists = event.target.querySelectorAll('.menu__dropdown-list');
      ...
      var menuX = event.target.getBoundingClientRect().x;
    ...
    // let navigate = document.querySelector('.rs-product__navigate');
    // let offset = 0;
    // if (navigate) {
