...
(function (factory) {
    ...
    $.fn.extend({
      easyResponsiveTabs: function easyResponsiveTabs(options) {
        ...
        this.each(function () {
          ...
          $respTabs.find('ul.resp-tabs-list li').addClass('resp-tab-item'); // $respTabs.css({
          //     'display': 'block',
          //     'width': jwidth
          // });
  ...
  var checkedElements = document.querySelectorAll('[data-checkviewport]');
  ...
  var menu = document.querySelector('.rs-header .rs-header__bottom');
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.certificates-slider__slider')) {
      var certificatesSlider = document.querySelector('.certificates-slider');
      var arrowPrev = certificatesSlider.querySelector('.slider-arrow_prev');
      var arrowNext = certificatesSlider.querySelector('.slider-arrow_next');
      new Swiper('.certificates-slider__slider', {
    ...
    if (document.querySelector('.projects-slider__slider')) {
      new Swiper('.projects-slider__slider', {
        observer: true,
        observeParents: true,
        slidesPerView: 'auto',
        spaceBetween: 30,
  ...
  window.onload = function () {
    ...
    $('#servicesTabs').easyResponsiveTabs(); // check viewport

    var checkedElements = document.querySelectorAll('[data-checkviewport]');
    checkedElements.forEach(function (el) {
      $(el).isInViewport(el.offsetHeight);
    }); //slider cursor
    // $('[data-cursor]').mouseout(function () {
