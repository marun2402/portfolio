...
(function (factory) {
  ...
  */
  ...
  function initSliders() {
    ...
    var favoritesSlider = document.querySelector('.favorites-slider');

    if (favoritesSlider) {
      var slider = favoritesSlider.querySelector('[class*="__slider"]');
      var arrowNext = favoritesSlider.querySelector('[class*="_next"]');
      var arrowPrev = favoritesSlider.querySelector('[class*="_prev"]'); //const pagging = gallerySlider.querySelector('[class*="__paging"]');
    ...
    if (reviewsSlider) {
      var _slider = reviewsSlider.querySelector('[class*="__slider"]');

      var _arrowNext = reviewsSlider.querySelector('[class*="_next"]');

      var _arrowPrev = reviewsSlider.querySelector('[class*="_prev"]'); //const pagging = gallerySlider.querySelector('[class*="__paging"]');
      ...
      var _disableEnableSlider = function _disableEnableSlider(evt) {
        if (evt.matches) {
          ...
          benefitSlider = new Swiper('.rs-benefit__content', {
            ...
            loop: false,
            navigation: {
              nextEl: '.rs-benefit__arrows .slider-arrow_next',
              prevEl: '.rs-benefit__arrows .slider-arrow_prev'
            },
            breakpoints: {
              992: {
                slidesPerView: 4
    ...
    if (document.querySelector('.rs-partners')) {
      var _disableEnableSlider2 = function _disableEnableSlider2(evt) {
        if (evt.matches) {
          ...
          partnersSlider = new Swiper('.rs-partners__content', {
            slidesPerView: 'auto',
            autoHeight: false,
            spaceBetween: 0,
            speed: 800,
  ...
  window.addEventListener('load', function (e) {
    ...
    var isSafari = /safari/.test(getBrowser$1().toLowerCase());
