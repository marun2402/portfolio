...
(function (factory) {
  ...
  ***************************************************************************** */
  ...
  window.onload = function () {
    ...
    // 		$(this).find('span.tilt').css({top: relY, left: relX});
    // 	})
    ...
    // 		$(this).find('span.tilt').css({top: relY, left: relX});
    // 	});
    // change photo on steps


    $('.stages-steps__list li h5').on('click', function () {
      var photoSrc = $(this).data('photo');
      $('.rs-stages__photo').addClass('active').children('img').attr('src', photoSrc);
      setTimeout(function () {
        $('.rs-stages__photo').removeClass('active');
      }, 500);
    });
  };
});