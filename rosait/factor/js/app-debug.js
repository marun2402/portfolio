  ...
  */
  ...
  function initSliders() {
    ...
    if (certificatesSlider) {
      var slider = certificatesSlider.querySelector('[class*="__slider"]');
      var arrowNext = certificatesSlider.querySelector('[class*="_next"]');
      var arrowPrev = certificatesSlider.querySelector('[class*="_prev"]');
      new Swiper(slider, {
        modules: [Navigation],
        observer: true,
        observeParents: true,
    ...
    var benefitSlider = document.querySelector('.benefit-slider');

    if (benefitSlider) {
      var _slider = benefitSlider.querySelector('[class*="__slider"]');

      var _arrowNext = benefitSlider.querySelector('[class*="_next"]');

      var _arrowPrev = benefitSlider.querySelector('[class*="_prev"]');
    ...
    var lettersSlider = document.querySelector('.letters-slider');

    if (lettersSlider) {
      var _slider2 = lettersSlider.querySelector('[class*="__slider"]');

      var _arrowNext2 = lettersSlider.querySelector('[class*="_next"]');

      var _arrowPrev2 = lettersSlider.querySelector('[class*="_prev"]');
  ...
  function gsapAnimations() {
    /////////////////////////////////////////////////////////////////////
    var block = document.querySelector('.rs-scope');

    if (block) {
      var items = block.querySelector('.rs-scope__items');
      ...
      tl.to(items, {
        x: function x() {
          ...
          var scrollWidth = items.offsetWidth - containerWidth;
          return -scrollWidth;
        }
      });
    }
