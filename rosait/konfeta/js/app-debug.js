...
(function (factory) {
  ...
  function stickyHeader(e) {
    ...
    // if (scrolled > 161 && scrolled > scrollPrev) {
  ...
  counters.forEach(function (counter) {
    var _end$toString$match;

    var end = counter.textContent;
    var length = (_end$toString$match = end.toString().match(/\.(\d+)/)) === null || _end$toString$match === void 0 ? void 0 : _end$toString$match[1].length;
    var options = {
    ...
    new CountUp(counter, end, options);
  }); //const anchors = document.querySelectorAll('[data-anchor-links] a[href*="#"]');
  // if (anchors) {
  ...
  $(document).ready(function () {
    $('[data-anchor-links] a[href*="#"]').bind('click', function (e) {
      var anchor = $(this);
  ...
  */
  ...
  function initSliders() {
    ...
    var constractionSliders = document.querySelectorAll('.constraction-item');
    constractionSliders.forEach(function (node, _) {
      new constractionSlider(node);
    }); // CARD SLIDERS ======================================================================================================
  ...
  var cardSlider = /*#__PURE__*/function () {
    function cardSlider($component) {
      ...
      this.$slider = $component.querySelector('.card-slider__slider');
      this.$arrowNext = this.$component.querySelector('.arrow_next');
      this.$arrowPrev = this.$component.querySelector('.arrow_prev');
  ...
  var constractionSlider = /*#__PURE__*/function () {
    function constractionSlider($component) {
      _classCallCheck(this, constractionSlider);

      this.$component = $component;
      this.$slider = $component.querySelector('.constraction-item__slider');
      this.$arrowNext = this.$component.querySelector('.arrow_next');
      this.$arrowPrev = this.$component.querySelector('.arrow_prev');
      this.$pagging = this.$component.querySelector('.constraction-item__pagging');
      this.render();
    }

    _createClass(constractionSlider, [{
      key: "render",
      value: function render() {
        new Swiper(this.$slider, {
  ...
  window.onload = function () {
    ...
    function clickActions(event) {
      ...
      if (window.innerWidth <= 991) {
        ...
        if (targetElement.closest('.menu-overlay') || targetElement.closest('.menu__list')) {
      ...
      // if (window.innerWidth > 991 && isMobile) {
      // 	if (targetElement.closest('.catalog-menu')) {
      // 		targetElement.closest('.catalog-menu').classList.toggle('hover');
      // 	}
      // }
