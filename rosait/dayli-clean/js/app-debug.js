...
(function (factory) {
  ...
  function checkViewport() {
    var elements = gsap.utils.toArray('span.accent');
  ...
  function initSliders() {
    ...
    var $mainSlider = document.querySelector('.rs-slider');
    if ($mainSlider) {
      var progressBar = $mainSlider.querySelector('.progress-bar');
      var total = progressBar.querySelector('.total');
      var bar = progressBar.querySelector('.bar');
      var mainSlider = new Swiper('.rs-slider__slider', {
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 900,
        loop: true,
        pagination: {
          el: '.rs-slider__nav .slider-paging',
          type: 'bullets',
          dynamicBullets: true,
          clickable: true
        },
        ...
        on: {
          init: function init(swiper) {
            ...
            total.innerHTML = swiper.slides.length < 10 ? '0' + swiper.slides.length : swiper.slides.length;
            var startProgress = 100 / swiper.slides.length;
            bar.style.cssText = "--h: ".concat(startProgress, "%");
          },
          ...
          transitionEnd: function transitionEnd(swiper) {
            swiper.slides[swiper.activeIndex].classList.add('is-active');
            var currentProgress = 100 / swiper.slides.length * (swiper.activeIndex + 1);
            bar.style.cssText = "--h: ".concat(currentProgress, "%");
          }
        }
      });
    ...
    if (logosSlider) {
      var slider = logosSlider.querySelector('[class*="__slider"]');
      var paging = logosSlider.querySelector('[class*="-paging"]');
      new Swiper(slider, {
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 800,
    ...
    if (partnersSlider) {
      ...
      var _paging = partnersSlider.querySelector('[class*="-paging"]');
      new Swiper(_slider, {
        slidesPerView: 'auto',
        spaceBetween: 100,
        autoHeight: false,
    ...
    //same sliders
    var servicesSliders = document.querySelectorAll('.services-slider');
    servicesSliders.forEach(function (node, _) {
      new servicesSlider(node);
    });
  }

  //same sliders	objects ==================================================================================================
  var servicesSlider = /*#__PURE__*/function () {
    function servicesSlider($component) {
      _classCallCheck(this, servicesSlider);
  ...
  ***************************************************************************** */
  ...
  window.addEventListener('load', function (e) {
    ...
    document.querySelectorAll('.btn-color, .btn-border').forEach(function (button) {
    ...
    $('.sidebar-menu .sidebar-menu__list .sidebar-menu-btn').click(function (event) {
      event.preventDefault();
    ...
    //accent underline
    var accentLines = document.querySelectorAll('span.accent');
    accentLines.forEach(function (line) {
      line.innerHTML = '<span>' + line.textContent + '</span>';
      if (line.dataset.width) {
        line.style.cssText += "--w: ".concat(line.dataset.width);
      }
      if (line.dataset.left) {
        line.style.cssText += "--l: ".concat(line.dataset.left);
      }
    });
  });
});