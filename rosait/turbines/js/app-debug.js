...
(function (factory) {
  ...
  function checkViewport() {
    var elements = gsap.utils.toArray('.intro, .rs-news__head, .rs-news__items, .rs-benefit__picture, .rs-services__head, .rs-services__content');
      ...
      new Swiper('.rs-slider__slider', {
        ...
        pagination: {
          ...
          renderBullet: function renderBullet(index, className) {
            ...
            return "<span class=\"".concat(className, "\">").concat(index, "<span></span></span>");
          }
        }
      });
    }
  ...
  ***************************************************************************** */
  ...
  function stickyHeaderAction(e) {
    ...
    //sticky header
    if (scrolled > offset && scrolled > window.innerHeight * 3) {
  ...
  function gsapAnimations() {
    ...
    if (intro) {
      ...
      var metricLines = gsap.utils.toArray('.intro-metrics__item svg path');
      var lineLength = metricLines[0].getTotalLength();
      ...
      tl.to('.intro-picture__overlay', {
        opacity: 1,
        duration: 0.1
      }, 0.3);
      tl.to('.intro-picture__bg', {
        scale: 1.2,
        duration: 0.5
      }, 0);
      tl.to('.intro-metrics', {
      ...
      tl.from('.intro-metrics__item:nth-child(1)', {
        opacity: 0,
        y: 100,
        scale: 0.7,
        duration: 0.2
      ...
      tl.from('.intro-metrics__item:nth-child(2)', {
        opacity: 0,
        y: 100,
        scale: 0.7,
        duration: 0.2
      ...
      tl.from('.intro-metrics__item:nth-child(3)', {
        opacity: 0,
        y: 100,
        scale: 0.7,
        duration: 0.2
      ...
      tl.from('.intro-metrics__item:nth-child(4)', {
        opacity: 0,
        y: 100,
        scale: 0.7,
        duration: 0.2
