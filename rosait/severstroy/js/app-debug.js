...
(function (factory) {
  ...
  $('.rs-portfolio__thumb-item').on('click', function () {
    $(this).siblings().removeClass("current");
    $(this).addClass("current");
    var beforeSrc = $(this).data('before');
    var afterSrc = $(this).children('img').attr('src');
    $('.ba-slider').children('img').attr('src', afterSrc);
    $('.ba-slider .resize').children('img').attr('src', beforeSrc);
    return false;
  });
  /**
   * SSR Window 4.0.2
  ...
  function Thumb(_ref) {
    ...
    function update(initial) {
      ...
      if (thumbsSwiper.params.loop || thumbsSwiper.params.virtual && thumbsSwiper.params.virtual.enabled) {
        ...
        for (var _i8 = 0; _i8 < thumbsToActivate; _i8 += 1) {
          thumbsSwiper.slides.eq(swiper.realIndex + _i8).addClass(thumbActiveClass);
        }
      }
    }
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.project-slider')) {
      var sliderThumbs = new Swiper(".project-slider-thumbs", {
        modules: [Thumb],
        spaceBetween: 30,
        slidesPerView: 'auto',
        freeMode: true,
      ...
      new Swiper(".project-slider-main", {
