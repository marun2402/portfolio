...
(function (factory) {
  ...
  da.init(); //const anchors = document.querySelectorAll('[data-anchor-links] a[href*="#"]');
  // if (anchors) {
  ...
  $(document).ready(function () {
    $('[data-anchors] a[href*="#"]').bind('click', function (e) {
      var anchor = $(this);
  ...
  // 	$('[data-anchor-links] li:first').addClass('active');
  // 	$('[data-anchor-links] li').click(function (event) {
  // 		$('[data-anchor-links] li').removeClass('active');
  ...
  function clickActions(event) {
    ...
    document.querySelector('.header-search-mobile');
    var input = document.querySelector('.header-search-mobile__input');

    if (targetElement.closest('.header-search-mobile-open')) {
    ...
    if (document.body.classList.contains('search-is-open')) {
      if (!targetElement.closest('.rs-header__search-mobile')) {
        document.body.classList.remove('search-is-open');
      }
  ...
  function checkViewport() {
    var elements = gsap.utils.toArray('.rs-brands__item.logo, .rs-title__logo, .checker-bg, .rs-dev__img, .text-block-logo');
  ...
  var Dom7 = /*#__PURE__*/function (_Array) {
    ...
    function Dom7(items) {
      ...
      if (typeof items === 'number') {
        _this3 = _super.call(this, items);
      } else {
        _this3 = _super.call.apply(_super, [this].concat(_toConsumableArray(items || [])));
        makeReactive(_assertThisInitialized(_this3));
      }
  ...
  */
  ...
  function initSliders() {
    ...
    if (catalogSlider) {
      var slider = catalogSlider.querySelector('[class*="__slider"]');
      var arrowNext = catalogSlider.querySelector('[class*="_next"]');
      var arrowPrev = catalogSlider.querySelector('[class*="_prev"]');
      var pagging = catalogSlider.querySelector('[class*="-paging"]');
      new Swiper(slider, {
    ...
    if (newsSlider) {
      var _slider = newsSlider.querySelector('[class*="__slider"]');

      var _arrowNext = newsSlider.querySelector('[class*="_next"]');

      var _arrowPrev = newsSlider.querySelector('[class*="_prev"]');

      var _pagging = newsSlider.querySelector('[class*="-paging"]');
    ...
    if (partnersSlider) {
      var _slider2 = partnersSlider.querySelector('[class*="__slider"]');

      var _arrowNext2 = partnersSlider.querySelector('[class*="_next"]');

      var _arrowPrev2 = partnersSlider.querySelector('[class*="_prev"]');

      var _pagging2 = partnersSlider.querySelector('[class*="-paging"]');
    ...
    if (projectsSlider) {
      var _slider3 = projectsSlider.querySelector('[class*="__slider"]');

      var _pagging3 = projectsSlider.querySelector('[class*="-paging"]');
    ...
    if (bannerSlider) {
      var _slider4 = bannerSlider.querySelector('[class*="__slider"]');

      var _arrowNext3 = bannerSlider.querySelector('[class*="_next"]');

      var _arrowPrev3 = bannerSlider.querySelector('[class*="_prev"]');
    ...
    var strategySlider = document.querySelector('.strategy-slider');

    if (strategySlider) {
      var _slider5 = strategySlider.querySelector('[class*="__slider"]');

      var _pagging4 = strategySlider.querySelector('[class*="-paging"]');
    ...
    var newsPhotoSlider = document.querySelector('.news-photo-slider');

    if (newsPhotoSlider) {
      var _slider6 = newsPhotoSlider.querySelector('[class*="__slider"]');

      var _arrowNext4 = newsPhotoSlider.querySelector('[class*="_next"]');

      var _arrowPrev4 = newsPhotoSlider.querySelector('[class*="_prev"]');
    ...
    } //disable-enable sliders on pages


    if (document.querySelector('.rs-brands')) {
      var disableEnableSlider = function disableEnableSlider(evt) {
        if (evt.matches) {
          ...
          brandsSlider = new Swiper('.rs-brands__content', {
            slidesPerView: 'auto',
            autoHeight: false,
            spaceBetween: 0,
            speed: 800,
  ...
  function gsapAnimations() {
    var parallaxElements = document.querySelectorAll('.rs-strategy__parallax');
  ...
  window.addEventListener('load', function (e) {
    ...
    if (document.querySelector('.rs-objects')) {
      $('.objects-card .text').each(function () {
        this.style.cssText = "--height: ".concat($(this).height(), "px");
      });
    }
  });
});