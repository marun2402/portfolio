...
(function (factory) {
  ...
  function checkViewport() {
    var nodes = gsap.utils.toArray('.rs-process__wrapper, .mgm');
      ...
      gsap.from(node, {
        scrollTrigger: {
          ...
          onEnter: function onEnter() {
            return node.classList.add('in-view');
          }
        }
      });
    });
    ...
    var charts = gsap.utils.toArray('.chart');
    var data = [[{
      y: 20,
      color: '#B4D093',
      name: 'normal'
