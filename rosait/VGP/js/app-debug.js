...
(function (factory) {
  ...
  function checkViewport() {
    var elements = gsap.utils.toArray('.section-anchor');
  ...
  var Dom7 = /*#__PURE__*/function (_Array) {
    ...
    function Dom7(items) {
      ...
      if (typeof items === 'number') {
        _this5 = _super.call(this, items);
      } else {
        _this5 = _super.call.apply(_super, [this].concat(_toConsumableArray(items || [])));
        makeReactive(_assertThisInitialized(_this5));
      }
  ...
  function outerWidth(includeMargins) {
    if (this.length > 0) {
      if (includeMargins) {
        var _styles5 = this.styles();

        return this[0].offsetWidth + parseFloat(_styles5.getPropertyValue('margin-right')) + parseFloat(_styles5.getPropertyValue('margin-left'));
      }
  ...
  function outerHeight(includeMargins) {
    if (this.length > 0) {
      if (includeMargins) {
        var _styles6 = this.styles();

        return this[0].offsetHeight + parseFloat(_styles6.getPropertyValue('margin-top')) + parseFloat(_styles6.getPropertyValue('margin-bottom'));
      }
  ...
  */
  ...
  function initSliders() {
    ...
    var techSlider = document.querySelector('.tech-slider');

    if (techSlider) {
      var slider = techSlider.querySelector('[class*="__slider"]');
      var arrowNext = techSlider.querySelector('[class*="_next"]');
      var arrowPrev = techSlider.querySelector('[class*="_prev"]');
      new Swiper(slider, {
    ...
    var topicSliders = document.querySelectorAll('.topic-slider');
    topicSliders.forEach(function (node, _) {
      new topicSlider(node);
    });
  } //same sliders	object==================================================================================================


  var topicSlider = /*#__PURE__*/function () {
    function topicSlider($component) {
      _classCallCheck(this, topicSlider);
  ...
  function gsapAnimations() {
    /////////////////////////////////////////////////////////////////////
    var fotoStock = document.querySelector('.foto-stock');

    if (fotoStock) {
      var fotoStockWidth = fotoStock.offsetWidth - window.innerWidth;
      var missionFotoSrockTL = gsap.timeline({
        scrollTrigger: {
          trigger: fotoStock,
          scrub: 0.8,
          start: 'top bottom',
      ...
      missionFotoSrockTL.to(fotoStock, {
        x: -fotoStockWidth
      });
    } /////////////////////////////////////////////////////////////////////


    var productsCatalog = document.querySelector('.rs-catalog');
    var containerWidth = document.querySelector('.rs-header__container').offsetWidth;

    if (productsCatalog) {
      var productCatalogItems = productsCatalog.querySelector('.rs-catalog__items');
      var productCatalogWidth = productCatalogItems.offsetWidth - containerWidth;
      var productsCatalogTL = gsap.timeline({
        scrollTrigger: {
          trigger: productsCatalog,
          start: 'top top',
          end: '+=2000px',
          pin: true,
          scrub: 0.8
      ...
      productsCatalogTL.to(productCatalogItems, {
        x: -productCatalogWidth
      });
    }
  ...
  */
  ...
  /safari/.test(getBrowser$1().toLowerCase()); // var is_opera = !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0;
  ...
  window.addEventListener('load', function (e) {
    ...
    var anchors = document.querySelectorAll('.btn-anchor:not(#scroll-top)');
