...
(function (factory) {
    ...
    _createClass(RangeSlider, [{
      ...
      value: function render() {
        ...
        this.$slider.noUiSlider.on('update', function (values, handle) {
          _this3.inputs[handle].value = values[handle];
          _this3.inputs[handle].dispatchEvent(new Event('input'));
        });
      }
    }]);
    return RangeSlider;
    ...
    _createClass(QuantityInput, [{
      ...
      value: function render() {
        ...
        this.$minusButton.onclick = function () {
          _this4.$input.value = _this4.$input.value > _this4.min ? parseInt(_this4.$input.value) - 1 : _this4.$input.value;
        };
        this.$plusButton.onclick = function () {
          if (_this4.max) {
            _this4.$input.value = _this4.$input.value < _this4.max ? parseInt(_this4.$input.value) + 1 : _this4.$input.value;
          } else {
            _this4.$input.value = parseInt(_this4.$input.value) + 1;
          }
        };
      }
    }]);
  ...
  function initSliders() {
    ...
    if (partnersSlider) {
      var slider = partnersSlider.querySelector('[class*="__slider"]');
      var prev = partnersSlider.querySelector('[class*="_prev"]');
      var next = partnersSlider.querySelector('[class*="_next"]');
      new Swiper(slider, {
        slidesPerView: 'auto',
        spaceBetween: 0,
        autoHeight: false,
    ...
    if (document.querySelector('.rs-popular')) {
      var disableEnableSlider = function disableEnableSlider(evt) {
        if (evt.matches) {
          ...
          newsSlider = new Swiper('.rs-popular__content', {
            slidesPerView: 'auto',
            autoHeight: false,
            spaceBetween: 10,
            speed: 500,
    ...
    if (document.querySelector('.rs-news')) {
      var _disableEnableSlider = function _disableEnableSlider(evt) {
        if (evt.matches) {
          if (_newsSlider !== undefined) {
            _newsSlider.destroy(true, true);
          }
        } else {
          _newsSlider = new Swiper('.rs-news__content', {
            slidesPerView: 'auto',
            autoHeight: false,
            spaceBetween: 25,
            speed: 500,
            loop: false,
            navigation: {
              nextEl: '.rs-news__nav .slider-arrow_next',
              prevEl: '.rs-news__nav .slider-arrow_prev'
            }
          });
        }
      };
