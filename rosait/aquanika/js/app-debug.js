...
(function (factory) {
    ...
    _createClass(RangeSlider, [{
      ...
      value: function render() {
        ...
        this.$slider.noUiSlider.on('update', function (values, handle) {
          _this.inputs[handle].value = values[handle];

          _this.inputs[handle].dispatchEvent(new Event('input'));
        });
      }
    }]);
  ...
  */
  ...
  window.onload = function () {
    ...
    var bubu = document.querySelectorAll('.form-group-provider input');
    var hold = document.querySelectorAll('.form-group-provider > span');

    var _loop = function _loop(i) {
      bubu[i].addEventListener('input', function () {
        hold[i].style.display = this.value == "" ? 'block' : 'none';
      });
    };
