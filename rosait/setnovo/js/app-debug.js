...
(function (factory) {
  ...
  */
  ...
  function initSliders() {
    ...
    if (aboutSlider) {
      var slider = aboutSlider.querySelector('.about-slider__slider');
      var arrowNext = aboutSlider.querySelector('.slider-arrow_next');
      var arrowPrev = aboutSlider.querySelector('.slider-arrow_prev');
      new Swiper(slider, {
        modules: [Navigation],
        observer: true,
        observeParents: true,
    ...
    var prodassetsSlider = document.querySelector('.prodassets-slider');

    if (prodassetsSlider) {
      var _slider = prodassetsSlider.querySelector('.prodassets-slider__slider');

      var _arrowNext = prodassetsSlider.querySelector('.slider-arrow_next');

      var _arrowPrev = prodassetsSlider.querySelector('.slider-arrow_prev');
  ...
  function checkViewport() {
    ...
    var elements = document.querySelectorAll('[data-checkviewport], .section-title, section:not(.rs-slider, .rs-logistic), .rs-slider, .rs-logistic__text-block, .text-block, .history-spollers, .history-today, .catalog-spollers');
  ...
  window.onload = function () {
    ...
    function clickActions(event) {
      ...
      } //open-close dropdown lang picker
    ...
    $('.accordion .accordion__tab').click(function (e) {
      e.preventDefault();
      $('.accordion .accordion__tab').removeClass('active');
    ...
    } // change photo on catalog spollers


    $('.catalog-spollers__head').on('click', function () {
      var photoNum = parseInt($(this).data('num'));
      var imgs = $('.catalog-spollers__img img').removeClass('active');
      $(imgs[photoNum - 1]).addClass('active');
    }); // change photo on history spollers

    $('.history-spollers__head').on('click', function () {
      var photoNum = parseInt($(this).data('num'));
      var imgs = $('.history-spollers__img img').removeClass('active');
      $(imgs[photoNum - 1]).addClass('active');
    });
  }; //history-tiles
  ...
  window.addEventListener('load', function () {
    if (document.querySelector('.rs-history')) {
      ...
      tl.fromTo('.history-tiles__line:nth-child(odd)', {
        x: 80
      }, {
        x: -80
      });
      tl2.fromTo('.history-tiles__line:nth-child(even)', {
        x: -80
      }, {
        x: 80
      });
  ...
  if (document.querySelector('.catalog-spollers')) {
    var currentUrl = window.location.href.split('#').pop();

    if (currentUrl) {
      document.getElementById(currentUrl).click(); //document.querySelector(`a[href="#${currentUrl}"]`).click();

      setTimeout(function () {
        document.querySelector('.rs-catalog__spollers').scrollIntoView({
          block: "center",
          inline: "center"
        });
      }, 200);
