...
(function (factory) {
  ...
  $.fn.isInViewport = function (height) {
    ...
    var isIn = elementBottom > viewportTop && elementBottom < viewportBottom;
  ...
  var checkedElements = document.querySelectorAll('[data-check-viewport]');
  $(window).on('load resize scroll', function () {
    checkedElements.forEach(function (el) {
      $(el).isInViewport(el.offsetHeight);
    });
  });
  /**
   * SSR Window 4.0.2
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.rs-reviews__slider')) {
      var nextArrow = document.querySelector('.rs-reviews .slider-arrow_next');
      var prevArrow = document.querySelector('.rs-reviews .slider-arrow_prev');
    ...
    if (document.querySelector('.rs-portfolio__slider')) {
      var _nextArrow = document.querySelector('.rs-portfolio .slider-arrow_next');

      var _prevArrow = document.querySelector('.rs-portfolio .slider-arrow_prev');

      new Swiper('.rs-portfolio__slider', {
  ...
  var cardSlider = /*#__PURE__*/function () {
    function cardSlider($component) {
      ...
      this.$arrowNext = this.$component.querySelector('.card-slider__arrow_next');
      this.$arrowPrev = this.$component.querySelector('.card-slider__arrow_prev');
