...
(function (factory) {
  ...
  var anchor = document.getElementById('scroll-down');
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.rs-news__slider')) {
      var pagging = document.querySelector('.rs-news .pagging');
      var arrowPrev = document.querySelector('.rs-news .arrow_prev');
      var arrowNext = document.querySelector('.rs-news .arrow_next');
      new Swiper('.rs-news__slider', {
        ...
        on: {
          init: function init(swiper) {
            var total = document.querySelector('.rs-news .fraction .fraction__total');
            var allSlides = document.querySelectorAll('.rs-news__slide:not(.swiper-slide-duplicate)').length;
            total.innerHTML = allSlides < 10 ? "0".concat(allSlides) : allSlides;
          },
          slideChange: function slideChange(swiper) {
            var current = document.querySelector('.rs-news .fraction .fraction__current');
            var activeSlide = swiper.realIndex + 1;
            current.innerHTML = activeSlide < 10 ? "0".concat(activeSlide) : activeSlide;
          }
        }
      });
    }
