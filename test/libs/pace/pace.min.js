...
!function () {
	...
	for (
		g = {
			...
			P = function () {
				var t;
				return null != (t = 'undefined' != typeof performance && null !== performance && 'function' == typeof performance.now ? performance.now() : void 0)
					? t
					: +new Date();
			},
	...
	function ot() {
		...
		(this.progress = null != (e = this.states[document.readyState]) ? e : 100),
			...
			(document.onreadystatechange = function () {
				return (
					null != n.states[document.readyState] && (n.progress = n.states[document.readyState]), 'function' == typeof t ? t.apply(null, arguments) : void 0
				);
			});
	}
	function it(t) {
	...
	(B = Error),
		...
		($.prototype.render = function () {
			...
			for (
				t = this.getElement(), r = 'translate3d(' + this.progress + '%, 0, 0)', s = 0, o = (i = ['webkitTransform', 'msTransform', 'transform']).length;
				s < o;
				s++
			)
