...
(function (factory) {
  ...
  function checkViewport() {
    ...
    var elements = document.querySelectorAll('.rs-mission__logo, .section-title');
  ...
  */
  ...
  function initSliders() {
    ...
    var portfolioSlider = document.querySelector('.portfolio-slider');

    if (portfolioSlider) {
      var slider = portfolioSlider.querySelector('[class*="__slider"]');
      var arrowNext = portfolioSlider.querySelector('[class*="_next"]');
      var arrowPrev = portfolioSlider.querySelector('[class*="_prev"]'); //const pagging = portfolioSlider.querySelector('[class*="__paging"]');
  ...
  function gsapAnimations() {
    ...
    parallaxElements.forEach(function (element) {
      var animElem = element.querySelector('.rs-parallax__wrapper img');
      gsap.from(animElem, {
        scrollTrigger: {
          trigger: element,
          start: 'top bottom',
  ...
  function animatePage() {
    ...
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        ...
        pageObserver.observe(_elm);
        var stagerElements = Array.from(_elm.children);
        stagerElements.forEach(function (elm, index) {
          animateStagerNamed(elm, index);
        });
      }
    } catch (err) {
      _iterator4.e(err);
  ...
  window.addEventListener('load', function (e) {
    ...
    var isSafari = /safari/.test(getBrowser().toLowerCase());
