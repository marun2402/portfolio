...
(function (factory) {
  ...
  function checkViewport() {
    ...
    var elements = document.querySelectorAll('p, h1, h2, h3, h4, h5, h6, .rs-ceo__photo-holder, span.v-strip, span.h-strip');
  ...
  function preloader() {
    ...
    function img_load() {
      loadedImg++;
      percentCount = (loadedImg / imagesCount * 100).toFixed();
  ...
  */
  ...
  function initSliders() {
    ...
    if (document.querySelector('.rs-mission__slider')) {
      new Swiper('.rs-mission__slider', {
        ...
        navigation: {
          nextEl: '.rs-mission .slider-arrow_next',
          prevEl: '.rs-mission .slider-arrow_prev'
        },
        on: {
          init: function init(swiper) {
            swiper.slides[swiper.activeIndex].classList.add('is-active');
    ...
    if (aboutSlider) {
      var slider = aboutSlider.querySelector('[class*="__slider"]'); // const arrowNext = aboutSlider.querySelector('[class*="_next"]');
      // const arrowPrev = aboutSlider.querySelector('[class*="_prev"]');
    ...
    if (partnersSlider) {
      var _slider = partnersSlider.querySelector('[class*="__slider"]');

      var arrowNext = partnersSlider.querySelector('[class*="_next"]');
      var arrowPrev = partnersSlider.querySelector('[class*="_prev"]');
      new Swiper(_slider, {
        modules: [Navigation],
        observer: true,
        observeParents: true,
    ...
    if (servicesSlider) {
      var _slider2 = servicesSlider.querySelector('[class*="__slider"]');

      var _arrowNext = servicesSlider.querySelector('[class*="_next"]');

      var _arrowPrev = servicesSlider.querySelector('[class*="_prev"]');

      var pagging = servicesSlider.querySelector('[class*="__paging"]');
      new Swiper(_slider2, {
    ...
    var accSliders = document.querySelectorAll('.acc-slider');
    accSliders.forEach(function (node, _) {
      new accSlider(node);
    }); // card sliders
  ...
  var cardSlider = /*#__PURE__*/function () {
    function cardSlider($component) {
      ...
      this.$slider = this.$component.querySelector('.card-slider__slider');
    ...
    _createClass(cardSlider, [{
      ...
      value: function render() {
        new Swiper(this.$slider, {
          ...
          slidesPerView: 'auto',
          grid: this.grid || {},
          spaceBetween: this.spaceBetween || 18,
          autoHeight: false,
          speed: 800,
  ...
  var accSlider = /*#__PURE__*/function () {
    function accSlider($component) {
      _classCallCheck(this, accSlider);

      this.$component = $component;
      this.$slider = this.$component.querySelector('.acc-slider__slider');
      this.$arrowNext = this.$component.querySelector('.slider-arrow_next');
      this.$arrowPrev = this.$component.querySelector('.slider-arrow_prev');
      this.render();
    }

    _createClass(accSlider, [{
      key: "render",
      value: function render() {
        new Swiper(this.$slider, {
          modules: [Navigation],
  ...
  function stickyHeaderAction(e) {
    ...
    if (scrolled > 301 && scrolled > scrollPrev) {
  ...
  function gsapAnimations() {
    ...
    var parallaxElements = document.querySelectorAll('.rs-parallax');
    parallaxElements.forEach(function (element) {
      var animElem = element.querySelector('.rs-parallax__photo');
    ...
    gsap.from('.about-slider__arrow', {
      scrollTrigger: {
        trigger: '.about-slider__title',
        start: 'bottom bottom',
        scrub: 0.8
      },
      x: 100,
    ...
    var triggerEl = document.querySelector('.services-slider');
    var aminEl = document.querySelector('.services-slider__wrapper');

    function showSlider(event) {
      var sliderY = triggerEl.getBoundingClientRect().y;

      if (sliderY < 30 && sliderY > -30) {
    ...
    tl4.to(aminEl, {
      ...
      height: '100vh',
      x: function x() {
        return -document.querySelector('.services-slider__wrapper').getBoundingClientRect().x;
      }
    }).to(aminEl, {
      scrollTrigger: {
        trigger: triggerEl,
